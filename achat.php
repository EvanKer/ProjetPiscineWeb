      ...
      <div class="card mt-4">
        ...
        <div class="card-body">
          ...
          <h4>Enchere actuelle :
           ...
           $requete='SELECT `prixActuel` FROM `sneakers` WHERE nom= "jordan1 chicago" ';
