...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <div class="container-fluid">
    ...
    <p>Contactez nous
    <br><br><br>
    Contact : <a href="mailto:quentin.lim.edu.ece.fr">quentin.lim@edu.ece.fr</a><br><br><br>
    Contact : <a href="mailto:evan.kermorgant.edu.ece.fr">evan.kermorgant@edu.ece.fr</a><br><br><br>
    Contact : <a href="mailto:axel.basocack.edu.ece.fr">axel.basocack@edu.ece.fr</a><br><br><br>
    </p>
     <br>
    <br>
    <br>
